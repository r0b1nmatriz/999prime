        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-300 mb-6">
              At 999Prime, we're not just adapting to the future—we're creating
              it. Our team of visionaries and technologists work at the
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-400">
                    Harnessing the power of quantum mechanics to solve complex
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-400">
                    Bridging the gap between human cognition and digital systems
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-semibold mb-2">
                    Revolt in Crypto-World
                  </h3>
                  <p className="text-gray-400">
                    Creating environmentally conscious Crypto-currency that
                    minimizes environmental impact while maximizing global
                    impact.
                  </p>
                </div>
              </div>
          ...
          <div className="relative h-[400px] lg:h-[500px] rounded-2xl overflow-hidden">
            ...
            <Image
              src="/azer.jpg?height=1080&width=1920"
